...
const getInventory = async () => {
  let results = await axios.get('https://faas-nyc1-2ef2e6cc.doserverless.co/api/v1/web/fn-675fbeb9-131e-478e-8c88-d28ad97b4e69/cloud/getCoffee');
...
const subscribeHandler = async function() {
  ...
  let emailUrl = "https://faas-nyc1-2ef2e6cc.doserverless.co/api/v1/web/fn-675fbeb9-131e-478e-8c88-d28ad97b4e69/cloud/postEmail" + "?email=" + email;
